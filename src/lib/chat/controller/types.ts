...
export type ChatControllerCtx = {
    ...
    get max_new_tokens_enabled(): boolean;
    set max_new_tokens_enabled(v: boolean);
    get max_new_tokens_value(): number;
    set max_new_tokens_value(v: number);
    get seed_enabled(): boolean;
    set seed_enabled(v: boolean);
    get seed_value(): number;
    set seed_value(v: number);
    get stop_sequences_text(): string;
    set stop_sequences_text(v: string);
    get reasoning_parse_enabled(): boolean;
    set reasoning_parse_enabled(v: boolean);
    get reasoning_start_tag(): string;
    set reasoning_start_tag(v: string);
    get reasoning_end_tag(): string;
    set reasoning_end_tag(v: string);
    get structured_output_enabled(): boolean;
    set structured_output_enabled(v: boolean);
